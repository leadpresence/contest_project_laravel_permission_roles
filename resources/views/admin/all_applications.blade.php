            ...
            <div class="card">
                <div class="body">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" hrefe="{{route('admin.all_applications')}}" href=""> All
                                Applications</a></li>
                        <li class="nav-item"><a class="nav-link" href="{{route('admin.applications')}}"> Accepted
                                Applications</a></li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.view',$application->id ) }}"
                                            class="btn btn-warning waves-effect waves-float btn-sm waves-red"> <i
